...
app.patch("/posts/:id", (req, res) => {
  ...
  const postToUpdateIndex = posts.findIndex((post) => post.id == req.params.id);
  const newPost = {
    id: postToUpdate.id,
  ...
  posts[postToUpdateIndex] = newPost;
  res.json(newPost);
});
...
app.delete("/posts/:id", (req, res) => {
  try {
    const deleteIndex = posts.findIndex((p) => p.id == req.params.id);
